...
| File | Description |
|---|---|
| `atp_examples.adesh` | Comprehensive demo of all ATP features (14 demos) |
| `atp_server.adesh` | Practical echo/chat/file server |
| `atp_client.adesh` | Practical client with mixed traffic patterns |
| `atp_production.adesh` | Production game-server microservice pattern |
| `atp_identity.adesh` | Ed25519 endpoint identity authentication |
| `atp_migration.adesh` | Path migration (PATH_CHALLENGE/RESPONSE) |
| `atp_retry_handshake.adesh` | Handshake DoS retry tokens |
| `atp_priority_streams.adesh` | Two-level priority + per-stream scheduling |
| `atp_loss_recovery.adesh` | Reliable delivery under packet loss |
